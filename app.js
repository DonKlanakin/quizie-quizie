document.addEventListener("DOMContentLoaded", async () => {
    ...
    async function loadQuestions() {
        ...
        try {
            ...
            autoCorrectButton.addEventListener("click", () => {
                const autoSelect = document.querySelector(`input[value="${questionsList[currentQuestionIndex].answer}"]`);
    ...
    function showCard() {
        ...
        try {
            playerLevelsCount = Math.floor(questionsCount / (cardLevelsCount === 0 ? 1 : cardLevelsCount));
            level = Math.floor(score / (playerLevelsCount === 0 ? 1 : playerLevelsCount));
